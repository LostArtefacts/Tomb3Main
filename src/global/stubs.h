...
#define Lara_GetHandAbsPosition_I ((void (*)(struct ITEM_INFO *item, struct PHD_VECTOR *vec, int16_t *frame1, int16_t *frame2, int32_t frac, int32_t rate, enum LARA_BODY_PART body_part))0x00443CA0)
...
#define Matrix_Push               ((void (*)(void))0x004B4280)
#define Matrix_PushUnit           ((void (*)(void))0x004B429E)
