...
enum OBJECT_ID {
    ...
    O_LON_MERCENARY_1 = 51,
    O_LON_MERCENARY_2 = 52,
    O_PUNK_1 = 53,
    O_PUNK_2 = 54,
    O_WATER_BLOKE = 55,
    O_SECURITY_GUARD = 56,
    ...
    O_AI_X_2 = 81,
    O_AI_X_3 = 82,
    O_FALLING_BLOCK_1 = 83,
    O_FALLING_BLOCK_2 = 84,
    O_FALLING_PLANK = 85,
    O_PENDULUM = 86,
    O_SPIKES = 87,
    O_ROLLING_BALL = 88,
    ...
    O_LIFT = 95,
    O_MOVING_BAR = 96,
    O_MOVABLE_BLOCK_1 = 97,
    O_MOVABLE_BLOCK_2 = 98,
    O_MOVABLE_BLOCK_3 = 99,
    O_MOVABLE_BLOCK_4 = 100,
    O_SMASH_WINDOW = 101,
    O_SMASH_OBJECT_1 = 102,
    O_SMASH_OBJECT_2 = 103,
    O_SMASH_OBJECT_3 = 104,
    O_SAW = 105,
    O_HOOK = 106,
    O_FALLING_CEILING_1 = 107,
    ...
    O_PUZZLE_ITEM_3 = 207,
    O_PUZZLE_ITEM_4 = 208,
    O_PUZZLE_OPTION_1 = 209,
    O_PUZZLE_OPTION_2 = 210,
    O_PUZZLE_OPTION_3 = 211,
    O_PUZZLE_OPTION_4 = 212,
    O_PUZZLE_HOLE_1 = 213,
    O_PUZZLE_HOLE_2 = 214,
    O_PUZZLE_HOLE_3 = 215,
    O_PUZZLE_HOLE_4 = 216,
    ...
    O_PICKUP_ITEM_1 = 236,
    O_PICKUP_ITEM_2 = 237,
    O_PICKUP_OPTION_1 = 238,
    O_PICKUP_OPTION_2 = 239,
    O_ICON_PICKUP_1_ITEM = 240,
    O_ICON_PICKUP_2_ITEM = 241,
    O_ICON_PICKUP_3_ITEM = 242,
    O_ICON_PICKUP_4_ITEM = 243,
    O_ICON_PICKUP_1_OPTION = 244,
    O_ICON_PICKUP_2_OPTION = 245,
    O_ICON_PICKUP_3_OPTION = 246,
    O_ICON_PICKUP_4_OPTION = 247,
    ...
    O_PICKUPDISPLAY_PUZZLE_1 = 268,
    O_PICKUPDISPLAY_PUZZLE_2 = 269,
    O_PICKUPDISPLAY_PUZZLE_3 = 270,
    O_PICKUPDISPLAY_PUZZLE_4 = 271,
    O_PICKUPDISPLAY_KEY_1 = 272,
    O_PICKUPDISPLAY_KEY_2 = 273,
    O_PICKUPDISPLAY_KEY_3 = 274,
    O_PICKUPDISPLAY_KEY_4 = 275,
    O_PICKUPDISPLAY_ICON_1 = 276,
    O_PICKUPDISPLAY_ICON_2 = 277,
    O_PICKUPDISPLAY_ICON_3 = 278,
    O_PICKUPDISPLAY_ICON_4 = 279,
    O_PICKUPDISPLAY_PICKUP_1 = 280,
    O_PICKUPDISPLAY_PICKUP_2 = 281,
    O_FIREHEAD = 282,
    O_TONYFIREBALL = 283,
    O_SPHERE_OF_DOOM_3 = 284,
    O_ALARM_SOUND = 285,
    O_WATER_DRIP = 286,
    O_TREX = 287,
    O_RAPTOR = 288,
    ...
    O_WHITE_LIGHT = 328,
    O_FLAME = 329,
    O_FLAME_EMITTER_1 = 330,
    O_FLAME_EMITTER_2 = 331,
    O_FLAME_EMITTER_3 = 332,
...
enum LARA_ANIM {
    ...
    LA_ALL_FOURS_2        = 264,
    LA_CRAWL              = 260,
    LA_ALL_FOURS_TURN_L   = 269,
    LA_ALL_FOURS_TURN_R   = 270,
    LA_ALL_FOURS_BACK     = 276,
    LA_HANG_TURN_L        = 271,
    LA_HANG_TURN_R        = 272,
    LA_HANG_TO_STOP       = 150,
    LA_HANG_TO_DUCK       = 287,
    LA_CRAWL_TO_HANG      = 289,
    LA_DUCK_PICKUP        = 291,
    LA_DUCK_PICKUP_F      = 312,
    LA_ALL_FOURS_PICKUP   = 291,
    LA_SPAZ_DUCK_F        = 294,
    LA_SPAZ_DUCK_B        = 293,
    LA_SPAZ_DUCK_L        = 296,
    LA_SPAZ_DUCK_R        = 295,
...
enum LARA_STATE {
    ...
    LS_HANG_TURN_L      = 82,
    LS_HANG_TURN_R      = 83,
    LS_ALL_FOURS_TURN_L = 84,
    LS_ALL_FOURS_TURN_R = 85,
    LS_CRAWL_BACK       = 86,
    LS_HANG_TO_DUCK     = 87,
    LS_CRAWL_TO_HANG    = 88,
    LS_LAST             = 89,
...
typedef void (*LaraCollisionRoutine)(
