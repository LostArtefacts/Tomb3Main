    ...
    struct PHD_VECTOR *vec, enum LARA_BODY_PART body_part)
{
    ...
    if (body_part == LBT_LEFT_FOOT) {
    ...
    } else if (body_part == LBT_RIGHT_FOOT) {
    ...
    } else if (body_part != LBT_LARA_HIPS) {
        ...
        if (body_part == LBT_LEFT_HAND || body_part == LBT_RIGHT_HAND) {
            ...
            } else if (body_part == LBT_RIGHT_HAND) {
